...
Meta Description: Run a technical SEO audit with this complete 3-tier checklist. Covers crawlability, Core Web Vitals, indexation, and more — prioritized by business impact.
...
**Mobile Usability**
- [ ] Site passes [Google's Mobile-Friendly Test](https://search.google.com/test/mobile-friendly)
...
- [ ] No schema validation errors in [Google's Rich Results Test](https://search.google.com/test/rich-results)
...
Use [Screaming Frog](https://www.screamingfrog.co.uk/seo-spider/) (desktop, free up to 500 URLs) or [Sitebulb](https://sitebulb.com/) (more visual, paid) to crawl your site.
...
Don't run [PageSpeed Insights](https://pagespeed.web.dev/) on every URL. Run it on your highest-traffic templates:
- Homepage
...
- [x] 5 external authority links (Screaming Frog, Sitebulb, Mobile-Friendly Test, PageSpeed Insights, Rich Results Test -- all hyperlinked)
